...
class OpenDataHubTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = OpenDataHubTestRunner.getenv("OPENDATAHUB_TEST_LIVE")
        override = OpenDataHubTestRunner.getenv("OPENDATAHUB_TEST_OVERRIDE")
        ...
        explain = OpenDataHubTestRunner.getenv("OPENDATAHUB_TEST_EXPLAIN")
