# OpenDataHub SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions OpenDataHubSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both OpenDataHubSDK(...) and OpenDataHubSDK.test(...) become
#      OpenDataHubSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "opendatahub_sdk"
_SDK_CLASS = "OpenDataHubSDK"
...
_ENTITIES = {
    "GetDataBrowser": "get_data_browser",
}
