...
from opendatahub_sdk.opendatahub_types import (
    GetDataBrowser,
...
class GetDataBrowserEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetDataBrowserEntity(self._client, opts)
    ...
    def data_get(self) -> GetDataBrowser:
    ...
    def match_get(self) -> GetDataBrowser:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[GetDataBrowser]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.GetDataBrowser().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
