...
// OpenDataHub SDK utility: graphql
//
...
class OpenDataHubGraphql
{
    ...
    // equivalent.
    public static function body(OpenDataHubContext $ctx): mixed
    {
    ...
    public static function errors(OpenDataHubContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
