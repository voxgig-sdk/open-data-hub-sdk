...
// OpenDataHub SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class OpenDataHubMakeRequest
{
    public static function call(OpenDataHubContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new OpenDataHubResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new OpenDataHubResponse($fetched);
        } else {
