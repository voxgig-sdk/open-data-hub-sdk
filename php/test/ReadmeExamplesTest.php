...
// OpenDataHub SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (OpenDataHubSDK::test)
...
{
    private const SDK_CLASS = 'OpenDataHubSDK';
    ...
    private const SDK_BASE = 'opendatahub_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../opendatahub_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
