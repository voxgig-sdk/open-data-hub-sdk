...
// OpenDataHub SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = OpenDataHubOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(OpenDataHubOmni::structfix($now, Struct::undef()))
                        !== json_encode(OpenDataHubOmni::structfix($val, Struct::undef()))) {
