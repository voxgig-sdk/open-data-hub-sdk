...
// OpenDataHub SDK netsim feature
...
class OpenDataHubNetsimFeature extends OpenDataHubBaseFeature
{
    ...
    private function _simulate(OpenDataHubContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(OpenDataHubContext $ctx, array $applied): void
    {
        $client = $this->client;
