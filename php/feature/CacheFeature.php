...
class OpenDataHubCacheFeature extends OpenDataHubBaseFeature
{
    ...
    private function _through(OpenDataHubContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
