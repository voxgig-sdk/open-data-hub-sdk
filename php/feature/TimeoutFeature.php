...
// OpenDataHub SDK timeout feature
...
class OpenDataHubTimeoutFeature extends OpenDataHubBaseFeature
{
    ...
    private function _with_timeout(OpenDataHubContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(OpenDataHubContext $_ctx, float $ms): void
    {
        $client = $this->client;
