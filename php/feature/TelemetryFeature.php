...
// OpenDataHub SDK telemetry feature
...
class OpenDataHubTelemetryFeature extends OpenDataHubBaseFeature
{
    ...
    private function _close(OpenDataHubContext $ctx, bool $ok): void
    {
