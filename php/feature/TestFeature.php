...
// OpenDataHub SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class OpenDataHubTestFeature extends OpenDataHubBaseFeature
{
    ...
    public function init(OpenDataHubContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (OpenDataHubContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = OpenDataHubParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (OpenDataHubContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(OpenDataHubContext $ctx, $op, $args): array
    {
