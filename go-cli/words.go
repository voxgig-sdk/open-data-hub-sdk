...
func registerSDKWords(r *eng.Registry, client *sdk.OpenDataHubSDK) {
...
func runOp(client *sdk.OpenDataHubSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
