...
type Args struct {
	Entity string         `json:"entity" jsonschema:"get_data_browser"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.OpenDataHubSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "open-data-hub_list",
		Description: "List records from OpenDataHub. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "open-data-hub_load",
		Description: "Load a single record from OpenDataHub. " +
...
func runOp(client *sdk.OpenDataHubSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.OpenDataHubSDK, name string) (sdk.OpenDataHubEntity, error) {
	switch strings.ToLower(name) {
	case "get_data_browser":
		return client.GetDataBrowser(nil), nil
