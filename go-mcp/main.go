// Command OpenDataHub-mcp is an MCP server exposing the OpenDataHub
// SDK as MCP tools.
//
// Two tools are registered:
//
//	OpenDataHub_list  — list records of an entity
//	OpenDataHub_load  — load a single record of an entity
//
