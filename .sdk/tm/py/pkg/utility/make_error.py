# OpenDataHub SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, OpenDataHubError):
        errmsg = err.msg
    ...
    msg = "OpenDataHubSDK: " + opname + ": " + errmsg
    ...
    sdk_err = OpenDataHubError("", msg, ctx)
