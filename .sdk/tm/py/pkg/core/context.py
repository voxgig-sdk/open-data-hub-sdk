...
from projectname_sdk.core.control import OpenDataHubControl
...
class OpenDataHubContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, OpenDataHubSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, OpenDataHubResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, OpenDataHubResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return OpenDataHubError(code, msg, self)
