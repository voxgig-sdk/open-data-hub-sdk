...
// OpenDataHub SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class OpenDataHubTransformResponse
{
    public static function call(OpenDataHubContext $ctx): mixed
    {
        ...
        $transform = OpenDataHubHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
