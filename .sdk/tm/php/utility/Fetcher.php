...
// OpenDataHub SDK utility: fetcher

class OpenDataHubFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; OpenDataHubSDK/1.0)';
    ...
    public static function call(OpenDataHubContext $ctx, string $fullurl, array $fetchdef): array
    {
