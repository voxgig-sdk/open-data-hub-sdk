...
class OpenDataHubProxyFeature extends OpenDataHubBaseFeature
{
    ...
    public function init(OpenDataHubContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (OpenDataHubContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
