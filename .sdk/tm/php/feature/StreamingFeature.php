...
// OpenDataHub SDK streaming feature
...
class OpenDataHubStreamingFeature extends OpenDataHubBaseFeature
{
    ...
    private function _iterate(OpenDataHubResult $result): \Generator
    {
    ...
    private function _streamable(OpenDataHubContext $ctx): bool
    {
