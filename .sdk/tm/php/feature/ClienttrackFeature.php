...
// OpenDataHub SDK clienttrack feature
...
class OpenDataHubClienttrackFeature extends OpenDataHubBaseFeature
{
    ...
    public function PostConstruct(OpenDataHubContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'OpenDataHub-SDK';
