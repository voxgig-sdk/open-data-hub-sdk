...
// OpenDataHub SDK ratelimit feature
...
class OpenDataHubRatelimitFeature extends OpenDataHubBaseFeature
{
    ...
    private function _acquire(OpenDataHubContext $ctx): void
    {
    ...
    private function _track(OpenDataHubContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
