...
class OpenDataHubRbacFeature extends OpenDataHubBaseFeature
{
    ...
    private function _required(OpenDataHubContext $ctx): ?string
    {
    ...
    private function _reject(OpenDataHubContext $ctx, string $required): void
    {
    ...
    private function _track(OpenDataHubContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
