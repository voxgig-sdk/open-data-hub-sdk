...
// OpenDataHub SDK metrics feature
...
class OpenDataHubMetricsFeature extends OpenDataHubBaseFeature
{
    ...
    private function _record(OpenDataHubContext $ctx, bool $ok): void
    {
