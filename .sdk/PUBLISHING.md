...
|---|---|---|
| `ts/` | @voxgig-sdk/open-data-hub-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/open-data-hub-sdk \
      --repository voxgig-sdk/open-data-hub-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/open-data-hub-sdk` shows it, and
`npm trust revoke @voxgig-sdk/open-data-hub-sdk --id=<id>` removes it.
