...
describe("GetDataBrowserDirect", function()
  it("should direct-list-get_data_browser", function()
    local setup = get_data_browser_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-get_data_browser", setup.live and "live" or "unit")
