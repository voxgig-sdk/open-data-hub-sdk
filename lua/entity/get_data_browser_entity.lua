...
local GetDataBrowserEntity = {}
GetDataBrowserEntity.__index = GetDataBrowserEntity


function GetDataBrowserEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetDataBrowserEntity)
  self._name = "get_data_browser"
  self._client = client
...
function GetDataBrowserEntity:get_name()
  return self._name
end


function GetDataBrowserEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetDataBrowserEntity.new(self._client, opts)
end
...
function GetDataBrowserEntity:mark_deleted()
  self._deleted = true
end


function GetDataBrowserEntity:deleted()
  return true == self._deleted
end


function GetDataBrowserEntity:data_set(args)
  if args ~= nil then
...
function GetDataBrowserEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetDataBrowserEntity:match_set(args)
  if args ~= nil then
...
function GetDataBrowserEntity:match_get()
...
function GetDataBrowserEntity:stream(action, args, callopts)
...
---@param reqmatch GetDataBrowserListMatch
---@param ctrl? table
---@return GetDataBrowser[]
---@return string? err
function GetDataBrowserEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function GetDataBrowserEntity:_run_op(ctx, post_done)
  local utility = self._utility
