...
class GetDataBrowserEntity extends OpenDataHubEntityBase_1.OpenDataHubEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'get_data_browser';
        this.name_ = 'get_data_browser';
        this.Name = 'GetDataBrowser';
    }
    make() {
        return new GetDataBrowserEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<GetDataBrowser[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.GetDataBrowserEntity = GetDataBrowserEntity;
//# sourceMappingURL=GetDataBrowserEntity.js.map