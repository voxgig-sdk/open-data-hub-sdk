...
(0, node_test_1.describe)('GetDataBrowserDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.OpenDataHubSDK({
    ...
    (0, node_test_1.test)('direct-list-get_data_browser', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-get_data_browser', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.OPEN_DATA_HUB_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.OpenDataHubSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['OPEN_DATA_HUB_TEST_GET_DATA_BROWSER_ENTID'];
    ...
    const client = new __1.OpenDataHubSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetDataBrowserDirect.test.js.map