...
type GetDataBrowserEntity struct {
	name    string
	client  *core.OpenDataHubSDK
...
func NewGetDataBrowserEntity(client *core.OpenDataHubSDK, entopts map[string]any) *GetDataBrowserEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetDataBrowserEntity) GetName() string { return e.name }
...
func (e *GetDataBrowserEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetDataBrowserEntity) Deleted() bool {
	return e.deleted
}


func (e *GetDataBrowserEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetDataBrowserEntity(e.client, opts)
}

func (e *GetDataBrowserEntity) Data(args ...any) any {
...
func (e *GetDataBrowserEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetDataBrowser; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetDataBrowserEntity) DataTyped(data ...GetDataBrowser) GetDataBrowser {
	if len(data) > 0 {
		return typedFrom[GetDataBrowser](e.Data(asMap(data[0])))
	}
	return typedFrom[GetDataBrowser](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetDataBrowser (all fields
// optional at the wire level).
func (e *GetDataBrowserEntity) MatchTyped(match ...GetDataBrowser) GetDataBrowser {
	if len(match) > 0 {
		return typedFrom[GetDataBrowser](e.Match(asMap(match[0])))
	}
	return typedFrom[GetDataBrowser](e.Match())
}
...
func (e *GetDataBrowserEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetDataBrowserEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *GetDataBrowserEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetDataBrowserListMatch and returns []GetDataBrowser. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GetDataBrowserEntity) ListTyped(reqmatch GetDataBrowserListMatch, ctrl map[string]any) ([]GetDataBrowser, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[GetDataBrowser](res), nil
}



func (e *GetDataBrowserEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetDataBrowserEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetDataBrowserEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetDataBrowserEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
