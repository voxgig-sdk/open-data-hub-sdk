...
#      offline in seeded test mode (OpenDataHubSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "OpenDataHub_sdk.rb")
  SDK_CLASS = "OpenDataHubSDK"
